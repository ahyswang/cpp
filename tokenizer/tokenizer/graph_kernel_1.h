...
// ----------------------------------------------------------------------------------------
    ...
    public:
        ...
        private:
            ...
            typedef std_allocator<node_type*> alloc_type;
            typedef std_allocator<std::shared_ptr<E>> alloc_edge_type;
    ...
    private:
        ...
        typedef std_allocator<std::shared_ptr<node_type>> alloc_type;
